...
//inital acceleration and velocity
float a1 = PI/2;
float a2 = PI/2;
float a1_v = 0;
float a2_v = 0;

// relative gravity constant
float g = 1;
...
void draw()
{
  //calculate first object acceleration
  ...
  //calculate second object acceleration
  num1 = 2 * sin(a1-a2);
